...
const badgeVariants = cva(
  "web:inline-flex items-center rounded-full border border-neutral-500 px-2.5 py-0.5 web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
