...
import Information from "../../../../../src/components/ui/profile/Information";
...
export default function App() {
  ...
  const userData: User = AuthStore.useState().userData;
  const userData1 = JSON.stringify(AuthStore.useState().userData);
  ...
  return (
    <View className="flex-1 items-center justify-between bg-background-light dark:bg-background-dark">
      <View style={{ width: "100%", height: IMG_HEIGHT }}>
        ...
        <View style={{ width: "100%", height: IMG_HEIGHT }}>
          <CachedImage
            source={{ uri: url, expiresIn: 2_628_288 }}
        ...
        <View style={{ alignItems: "center" }}>
          ...
          >
            <CachedImage
              source={{ uri: url, expiresIn: 2_628_288 }}
              cacheKey={`${userData.uid}-profile-main`}
              placeholderContent={
                <Image
              ...
              <View className="flex flex-row items-center justify-center w-full mt-5">
                <View className="flex flex-row items-center justify-center">
                  <Ionicons
                    ...
                    style={{ marginRight: 8 }}
                  />
                  <Text className="text-text-light dark:text-text-dark text-sm text-center">
                    {school?.toString().toLocaleUpperCase()}
                  </Text>
                </View>
              </View>
            </View>
